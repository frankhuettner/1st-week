...
# Get data from csv file for a particular stock
def get_data_from_csv(stock):

    # COMPLETE THIS FUNCTION !!!!!!!!!!!!!!!!!!!!!!!!!
    # Careful: You need to use the entire path to "sp500_data.csv"
    # Tip: Righ-click on the file in the Explorer area of VS Code and choose "copy path"
